            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="category">Kategori Ekleme Sayfasındasınız</p>
                    </div>
                    <div class="card-body">

                        <div style="width:1000px; height: auto; padding-left: 400px;" >
                            <form action="{{route('admin_category_create')}}" method="post">
                                @csrf
                                <table>

                                    <tr><h4>Parent Id:</h4> <select name="parent_id" id="parent_id" >
                                    ...
                                    <tr><label for="status"><h4>Status:</h4></label>
                                        ...
                                        <select name="status" id="home-status">
